...
campaignTrail_temp.credits = "Ohas and UlricMorningstarG"
...
jet_data = {
    "headerColor": "#a8c6fe",
    "windowColor": "#a8c6fe",
    "containerColor": "#f4a4c0",
    "innerWindowColor": "#E8FBFF",
    "bannerImageUrl": "https://i.imgur.com/EMGFKOc.jpeg",
...
campaignTrail_temp.candidate_json = [
    ...
    },
    {
        ...
        "fields": {
            ...
            "electoral_loss_message": "This guy loses!",
            "no_electoral_majority_message": "We all win?",
            "description_as_running_mate": "To say that the democratic party of Alabama has nothing democratic about it would be stating plain facts.<br><br>Since the end of reconstruction and the near total disenfranchisement of all blacks in the state, the party has run functionally unopposed for nearly a century. Champion of the status quo, white interest and the continued domination of White on the segregated blacks, it was only with the walkout of 48 that things began to change.<br><br>The party has since become divided between progressivist, racial moderates and the hard line segregationist. No other party having any influence in the state, this has turned this party into a truly cutthroat institution where each and every member backstab and double cross their neighbor to gain power for themselves.<br><br>As a result of it, the perfectly dysfunctional institution is finally beginning to show cracks as the segregationist party took back control in 1958. If anything was to improve in the state so long seen as the least of the 50 states, decisive action needs to be taken.",
            "candidate_score": 1,
            "running_mate": true
        }
    },
...
jet_data = {
                ...
                "backgroundImageUrl": "https://coolbackgrounds.io/images/backgrounds/white/pure-white-background-85a2a7fd.jpg",
                "endingTextColor": "#000000",
                "customQuote": "\"I advocate hatred of no man, because hate will only compound the problems facing the South.\"",
                "gameTitle": "Sweet Home"
            }
...
corrr = '\n              <h2>Sweet Home</h2><font id="wittyquote" size="4" color="white"><em>"I advocate hatred of no man, because hate will only compound the problems facing the South."</em></font>\n            ';
